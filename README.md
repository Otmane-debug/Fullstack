...
run "python3 manage.py runserver" on back folder and "npm start on front forlder
...
![alt text](https://github.com/Otmane-debug/Fullstack-Ecommerce-Web-App/blob/main/front/register.png)
